...
app.post('/deleteonevent', authMiddleware, (req, res) => {
    dataServices.deleteonevent(req,req.body.event)
    .then(result=>{
        res.status(result.statusCode).json(result)
    })
...
app.post('/saveoneevent', authMiddleware, (req, res) => {
    dataServices.saveoneevent(req,req.body.i,req.body.date1,req.body.event1)
    .then(result=>{
        res.status(result.statusCode).json(result)
    })
