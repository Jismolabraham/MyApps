...
deleteoneevent(event:any){
  const data={
    event
  }
  return this.http.post("http://localhost:3000/deleteonevent",data,options)
}
saveoneevent(i:any,date1:any,event1:any){
const data={
  i,date1,event1
}
// alert(event1)
return this.http.post("http://localhost:3000/saveoneevent",data,options)
}
remind(dateonly:any){
